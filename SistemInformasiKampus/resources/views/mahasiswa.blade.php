    ...
    <div class="p-6 border-b border-gray-200">
        <form action="{{ route('mahasiswa.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="border-2 border-gray-300 p-2 w-full" name="nama_mahasiswa" id="nama_mahasiswa" required>
            </div>
            <div class="mb-4">
            ...
            <br>
            <div class="mb-4">
                <button type="submit" class="bg-blue-500 text-white px-4 py-3 rounded font-medium w-full">Tambah Mahasiswa</button>
            </div>
        </form>
    </div>
    <table class="mahasiswa-table">
        ...
        <tbody>
            @foreach ($mahasiswa as $item)
                <tr>
                    <td>
                        <a href="{{ route('mahasiswa.view', ['id' => $item->id]) }}"><u>Edit</u></a>
                        <a href="{{ route('mahasiswa.delete', ['id' => $item->id]) }}"><u>Delete</u></a>
                    </td>
